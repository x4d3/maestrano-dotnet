    ...
    public static class TimeZoneConverter
    {
        ...
        public static TimeZoneInfo fromOlsonTz(string olsonTimeZoneId)
        {
            ...
            try { windowsTimeZone = TimeZoneInfo.FindSystemTimeZoneById(windowsTimeZoneId); }
              ...
              Console.WriteLine("TIMEZONE WAS NOT FOUND");
            }
            catch (InvalidTimeZoneException) {
              Console.WriteLine("TIMEZONE IS INVALID");
            }
        ...
        static TimeZoneConverter() {
          isUnix = Regex.IsMatch(Environment.OSVersion.ToString(),"Unix", RegexOptions.IgnoreCase);

          olsonWindowsTimes = new Dictionary<string, string>
          {
